...
const App = () => {
  return (
    <div className="w-full overflow-hidden font-sans">
      {/* ===== Hero Section with Wave Animation and Floating Text ===== */}
      <div className="relative h-[300px] bg-[#5E847E] flex items-center justify-center text-white">
        <motion.h1
      ...
      {/* ===== Footer Section ===== */}
      <div className="bg-[#5E847E] text-white pt-20 px-6 md:px-16 -mt-1">
        ...
        >
          <p>© 2025 Satvic Movement. All Rights Reserved.</p>
